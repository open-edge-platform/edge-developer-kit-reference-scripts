...
export function RagChatSettings({
  isOpen,
  onClose,
  useEmbedding,
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure RAG (Retrieval-Augmented Generation) settings to enhance
            responses with knowledge bases
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-xs">
                  Use knowledge bases to provide context-aware responses
                </p>
              </div>
              <Switch
            ...
            {!isEmbeddingServiceActive && (
              <Alert>
                ...
                <AlertDescription className="text-sm">
                  ...
                  before enabling RAG functionality.
                </AlertDescription>
              </Alert>
            )}
            ...
            {localUseEmbedding && isEmbeddingServiceActive && (
              <Alert>
                <Info className="h-4 w-4" />
                <AlertDescription className="text-sm">
                  When enabled, the chat will use the selected knowledge base to
                  provide more informed responses based on your documents.
                </AlertDescription>
              </Alert>
            )}
          </div>
