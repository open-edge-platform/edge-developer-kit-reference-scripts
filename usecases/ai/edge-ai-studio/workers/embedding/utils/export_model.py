...
def export_text_generation_model(
    ...
    graph_content = gtemplate.render(
        tokenizer_model="{}_tokenizer_model".format(model_name),
        embeddings_model="{}_embeddings_model".format(model_name),
