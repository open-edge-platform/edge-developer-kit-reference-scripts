...
export const lipsyncEndpoints: EndpointProps[] = [
  {
    title: 'Avatar Chat API',
    description:
      'Send text messages to the avatar for speech synthesis and lip-sync animation. Supports echo, clear history, and stop commands.',
    path: '/chat',
    body: `{
  "chat_type": "echo",
  "session_id": "1234",
  ...
  {
    title: 'Avatar Stop API',
    description: 'Stop the current avatar response or interaction.',
    path: '/stop',
    body: `{
  "chat_type": "stop",
  "session_id": "1234"
  ...
  {
    title: 'WebRTC Offer API',
    description:
      'Initialize a WebRTC connection with the avatar server for real-time video streaming with lip-sync.',
    path: '/offer',
    body: `{
