...
import json
import time
import subprocess # nosec B404 - test file only, subprocess used safely with no shell=True
import signal
from pathlib import Path

class TestData_analysis_serverServer(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.server_process = None
        cls.port = int(os.getenv('MCP_DATA_ANALYSIS_SERVER_PORT', 7905))
