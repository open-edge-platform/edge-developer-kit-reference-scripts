...
/**
 * Draw the app icon, without pulling in an image library.
 *
 * electron-builder wants a 512px .png (Linux) and a .ico (Windows); the
 * artwork is a kiosk terminal — a screen on a stand. Replace the PNGs with
 * real artwork whenever there is some.
 */
