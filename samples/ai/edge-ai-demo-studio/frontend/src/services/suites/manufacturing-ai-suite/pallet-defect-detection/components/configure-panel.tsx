...
const MODEL_NAME = 'pallet-defect-detection'
...
interface PddConfigurePanelProps {
  service: Service
}

export function PddConfigurePanel({ service }: PddConfigurePanelProps) {
  const currentDevice =
      ...
      <div className="space-y-3 px-2">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-[11px]">
            Takes effect on next service start. Selects the DL Streamer pipeline
            (CPU/GPU/NPU) used for pallet defect detection.
          </p>
        </div>
      </div>
    </ServiceConfigurePanel>
